...
<body>
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        ...
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('images/sibarang-logo.png') }}" class="w-10 h-10" alt="Flowbite Logo">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SiBarang</span>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contact</button>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <p class="text-md font-light text-pretty text-gray-500 sm:text-xl/8">Kelola Inventaris Lebih Mudah, Cepat, dan Akurat.</p>
        </div>
        </div>
    </nav>
    ...
    <aside id="separator-sidebar" class="fixed top-0 left-0 z-10 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 mt-16" aria-label="Sidebar">
    ...
    <div class="p-4 sm:ml-64 mt-20">
        <div class="max-w-md mx-auto py-12 px-6">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Lengkapi dan perbarui informasi profil Anda agar akun lebih aman dan mudah dikenali.
            </p>
            </div>
            ...
            <!-- Tombol Edit -->
            <button onclick="openEditProfileModal({{ Auth::user()->id }}, '{{ Auth::user()->name }}', '{{ Auth::user()->email }}')" type="button"
                class="col-span-1 w-full text-xs font-medium text-white bg-blue-600 rounded mt-5 px-3 py-2 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition">
                Edit
            </button>
            </div>
        </div>
        ...
        {{-- edit profile --}}
        <script>
            function openEditProfileModal(id, name, email) {
                document.getElementById('editProfileModal').classList.remove('hidden');
                document.getElementById('editProfileName').value = name;
                document.getElementById('editProfileEmail').value = email;
                // Set action form ke /updateprofile/{id}
                document.getElementById('editProfileForm').action = '/updateprofile/' + id;
            }
        ...
        <div id="editProfileModal" class="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm hidden">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
                <button type="button" onclick="closeEditProfileModal()" class="absolute top-2 right-2 text-gray-400 hover:text-gray-600 text-2xl">&times;</button>
                <h2 class="text-xl font-semibold mb-4">Edit Profile</h2>
                <form id="editProfileForm" method="POST" class="space-y-4">
                    @csrf
                    @method('POST')
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">Foto Profil</label>
                        <input type="file" name="photo" id="editProfilePhotoInput" accept="image/*" class="w-full text-sm border rounded px-3 py-2">
                    </div>

                    <!-- preview crop -->
                    <div class="w-full">
                        <img id="photoPreview" class="max-h-64 mx-auto rounded-lg hidden" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="editProfileName" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
                    </div>
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="email" id="editProfileEmail" required class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
                    </div>
                    <div class="flex justify-end gap-2">
                        <button type="button" onclick="closeEditProfileModal()" class="px-4 py-2 rounded bg-gray-200 hover:bg-gray-300 text-gray-700">Batal</button>
        ...
        <script>
            ...
            input.addEventListener('change', function(e) {
                ...
                reader.onload = function(event) {
                    ...
                    cropper = new Cropper(preview, {
                        aspectRatio: 1, // bikin persegi (bisa ubah sesuai kebutuhan)
                        viewMode: 1,
                        autoCropArea: 1,
                    });
                };
            ...
            // sebelum submit ambil hasil crop
                ...
                if (cropper) {
                    ...
                    cropper.getCroppedCanvas({
                        ...
                        reader.onloadend = function() {
                            croppedInput.value = reader.result; // base64 hasil crop
                            e.target.submit(); // kirim form setelah crop
                        };
